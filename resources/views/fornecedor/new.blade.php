                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                        ...
                                        {{Form::text('entidade', null, ['class'=>"form-control", 'placeholder'=>"Nome do Fornecedor"])}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                        ...
                                        {{Form::select('id_provincia', $getProvincias, null, ['class'=>"form-control provincia", 'placeholder'=>"Província"]) }}
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group municipio">
                                        ...
                                        {{Form::select('id_municipio', [], null, ['class'=>"form-control", 'placeholder'=>"Muncípio"]) }}
